...
public class ImageProcessorUtils {
    /**
     * Ensures that the given object is not null. If it is null, throws a new IllegalArgumentException with the given
     * message.
    ...
    /**
     * Takes in red, green, and blue values and clamps them in the range [0,255] so that each value is valid for a pixel.
