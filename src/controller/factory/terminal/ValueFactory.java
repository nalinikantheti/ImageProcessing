...
public class ValueFactory extends AbstractTwoStringFactory {
  /**
   * Creates a new ValueFactory with the given view and scanner.
  ...
  /**
   * Creates a {@link ValueCommand} that takes in the name of the image to
   * operate on and saves the resulting image,
   * naming it the second argument.
   *
   * @param s1 the name of the image to operate on
   * @param s2 the name of the resulting image
   * @return an Optional of a new Value Command  containing a valid command
   */
  @Override
