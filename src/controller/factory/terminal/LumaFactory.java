...
public class LumaFactory extends AbstractTwoStringFactory {
  /**
   * Creates a new LumaFactory with the given view and scanner.
  ...
  /**
   * Creates a new {@link LumaCommand} that takes in an image that has a name
   * matching the first argument and saves
