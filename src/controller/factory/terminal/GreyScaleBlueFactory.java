...
public class GreyScaleBlueFactory extends AbstractTwoStringFactory {
  /**
   * Creates a new GreyScaleBlueFactory with the given view and scanner.
  ...
  /**
   * Creates a new {@link GreyScaleBlueCommand} that takes in the image with the
   * name of the first string argument
   ...
   * @return a Optional of a new GreyScaleBlueCommand  containing a valid command
   */
  @Override
