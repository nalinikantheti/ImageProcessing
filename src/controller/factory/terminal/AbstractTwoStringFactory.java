...
public abstract class AbstractTwoStringFactory extends AbstractCommandFactory {
  /**
   * Creates a new AbstractTwoStringFactory with the given view and scanner.
  ...
  /**
   * Waits for two string inputs and converts them into a command.
   * If either parameter is quit keyword or there is no
   * more input, then this method returns an empty {@code Optional}
   * and outputs a corresponding message. Otherwise,
  ...
  /**
   * Converts two string arguments into a command.
   * The returned command varies depending on the implementation.
   *
