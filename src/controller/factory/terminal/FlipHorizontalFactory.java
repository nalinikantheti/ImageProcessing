...
public class FlipHorizontalFactory extends AbstractTwoStringFactory {
  /**
   * Creates a new FlipHorizontalFactory with the given view and scanner.
  ...
  /**
   * Creates a new {@link FlipHorizontalCommand} that flips the image with
   * the name of the first argument and saves
   ...
   * @return a new Optional of a new FlipHorizontal Command  containing a valid command.
   */
  @Override
